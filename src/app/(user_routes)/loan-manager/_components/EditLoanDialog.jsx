...
export function EditLoanDialog({ loan, onSuccess, onClose }) {
      ...
      <DialogContent className="bg-white dark:bg-gray-800 sm:max-w-md p-6">
        ...
        <form onSubmit={handleSubmit} className="grid gap-4 py-4">
          ...
          <div className="grid gap-2">
            <label htmlFor="edit_loan_amount" className="text-sm font-medium text-gray-700 dark:text-gray-300">
              Loan Amount (৳)
            </label>
            <input
              id="edit_loan_amount"
          ...
          {/* Due Date */}
          <div className="grid gap-2">
            <label htmlFor="edit_payment_due_date" className="text-sm font-medium text-gray-700 dark:text-gray-300">
              Payment Due Date
            </label>
            <input
