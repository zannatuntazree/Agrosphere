        ...
        <div className="flex flex-col sm:flex-row items-center gap-6 mb-6">
          ...
          <div className="text-center sm:text-left flex-1">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-start md:mr-20 gap-4 mt-4 sm:mt-0">
                ...
                <button
                  ...
                  className="inline-flex md:mt-2 items-center justify-center rounded-full text-sm font-medium h-10 w-32 px-4 py-2 bg-gradient-to-r from-sky-400 to-blue-500 text-white hover:from-sky-500 hover:to-blue-600 cursor-pointer transition-all duration-300 shadow-md hover:shadow-lg whitespace-nowrap"
                >
                  <FaUserPlus className="mr-2 flex-shrink-0" />
                  <span>
