      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="bg-white dark:bg-slate-800 rounded-xl p-4 border border-gray-200 dark:border-slate-700 shadow-md dark:shadow-xl"
            >
          ...
          <div className="text-center sm:text-left flex-1">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-start flex-col md:flex-row  gap-4 mt-4 sm:mt-0">
                ...
                <div className="text-center mx-auto flex-shrink-0 mt-2 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm rounded-xl p-3 border border-green-200/50 dark:border-slate-700/50">
                ...
                <div className="flex flex-row md:flex-col gap-3 min-w-[140px]">
                  ...
                  <button className="inline-flex items-center justify-center rounded-full text-sm font-semibold h-11 w-full px-4 py-2 bg-gradient-to-r from-emerald-500 to-teal-600 text-white hover:from-emerald-600 hover:to-teal-700 cursor-pointer transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98]">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {user.preferred_crops.map((crop, i) => (
                      <div
                        key={i}
                        className="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold bg-green-200 dark:bg-green-800 text-green-800 dark:text-green-200 shadow-sm"
                      >
                        {crop}
                      </div>
                    ))}
